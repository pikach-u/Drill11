...
# Boy Action Speed
TIME_PER_ACTION = 0.5   #이 부분은 내가 계산해보고 임의로 정하면 됨. 한 사이클을 몇 초로 할건지?
...
class Idle:
    ...
    @staticmethod
    def do(boy):
        boy.frame = (boy.frame + FRAMES_PER_ACTION * ACTION_PER_TIME * game_framework.frame_time) % 8 #애니메이션 프레임 타임
